...
class Easy_Facebook_Likebox
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style(
            $this->plugin_slug . '-animate',
            plugins_url( 'assets/css/animate.css', __FILE__ ),
            array(),
            self::VERSION
        );
        wp_enqueue_style(
    ...
    public function enqueue_scripts()
    {
        wp_enqueue_script(
            ...
            plugins_url( 'assets/popup/jquery.magnific-popup.min.js', __FILE__ ),
            array( 'jquery' ),
            self::VERSION
        );
        // plan end
        ...
        wp_enqueue_script(
            ...
            array( 'jquery', $this->plugin_slug . '-popup-script', $this->plugin_slug . '-cookie-script' ),
            self::VERSION
        );
