...
//Input field
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Customize_MIF_PopUp' ) ) :
class Customize_MIF_PopUp extends WP_Customize_Control
{
    ...
    { 
        ...
        <p><?php echo __('Upgrade today and get a 25% discount! On the checkout click on "Have a promotional code?" and enter <code>BLACKFRIDAY25</code>', 'easy-facebook-likebox') ?> </p>
